...
def main():
    ...
    data_file_1 = st.sidebar.file_uploader("Dados RFV", type = ['csv','xlsx'])
    ...
    if (data_file_1 is not None):
        ...
        st.write(" - Faremos a segmentação dos clientes com base em quartis")
        st.write(' - Caso seja de interesse um número maior ou menor de classes, basta aumentar ou diminuir a quantidade de quantis')
